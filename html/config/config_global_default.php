 ...
 * @example
 * $_config['db']['1']['dbhost'] = '172.17.0.2:3306'; // 服务器地址
 * $_config['db']['1']['dbuser'] = 'root'; // 用户
 * $_config['db']['1']['dbpw'] = '7ObpQfctgabbozth';// 密码
 * $_config['db']['1']['dbcharset'] = 'gbk';// 字符集
 * $_config['db']['1']['pconnect'] = '0';// 是否持续连接
 * $_config['db']['1']['dbname'] = 'discuz';// 数据库
 * $_config['db']['1']['tablepre'] = 'pre_';// 表名前缀
 *
 * $_config['db']['2']['dbhost'] = '172.17.0.2:3306';
 * ...
 *
 */
$_config['db'][1]['dbhost']  		= '172.17.0.2:3306';
$_config['db'][1]['dbuser']  		= 'root';
$_config['db'][1]['dbpw'] 	 	= '7ObpQfctgabbozth';
 ...
 * @example
 * $_config['db']['1']['slave']['1']['dbhost'] = '172.17.0.2:3306';
 * $_config['db']['1']['slave']['1']['dbuser'] = 'root';
 * $_config['db']['1']['slave']['1']['dbpw'] = '7ObpQfctgabbozth';
 ...
 *
 * $_config['db']['1']['slave']['2']['dbhost'] = '172.17.0.2:3306';
 * ...
 *
 */
